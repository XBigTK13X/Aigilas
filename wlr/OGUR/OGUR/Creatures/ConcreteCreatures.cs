...
namespace OGUR.Creatures
{
    public class Player : AbstractCreature
    {
        ...
        public Player(int playerIndex): base(CreatureType.PLAYER, SpriteType.PLAYER_STAND, new SlothAcolyte())
        {
            ...
            m_baseStats = new Stats(100f, 100f, 10f, 10f, 10f, 10f, 35f, 50f, 6.0f, Stats.DefaultMoveSpeed, 6);
            m_maxStats = new Stats(100f, 100f, 10f, 10f, 10f, 10f, 35f, 50f, 6.0f, Stats.DefaultMoveSpeed, 6);
        }
    }

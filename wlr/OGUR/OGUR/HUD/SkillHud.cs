...
namespace OGUR.HUD
{
    public class SkillHud:IHud
    {
        ...
        public void Draw()
        {
            ...
            XnaManager.Renderer.Draw(m_menuBase, GetHudOrigin(), new Rectangle(0, 0, 1, 1), new Color(0f, 0f, 0f, .4f), 0f, new Vector2(0, 0), m_dimensions, SpriteEffects.None, ZDepth.HudBG);
            m_textHandler.Draw();
        }
